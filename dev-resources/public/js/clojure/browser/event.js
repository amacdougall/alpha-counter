...
goog.require('goog.events');
clojure.browser.event.EventType = (function (){var obj7426 = {};return obj7426;
})();
clojure.browser.event.event_types = (function event_types(this$){if((function (){var and__3526__auto__ = this$;if(and__3526__auto__)
...
{var x__4165__auto__ = (((this$ == null))?null:this$);return (function (){var or__3538__auto__ = (clojure.browser.event.event_types[goog.typeOf(x__4165__auto__)]);if(or__3538__auto__)
{return or__3538__auto__;
} else
{var or__3538__auto____$1 = (clojure.browser.event.event_types["_"]);if(or__3538__auto____$1)
...
return (function (p__7427){var vec__7428 = p__7427;var k = cljs.core.nth.call(null,vec__7428,0,null);var v = cljs.core.nth.call(null,vec__7428,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
...
return (function (p__7429){var vec__7430 = p__7429;var k = cljs.core.nth.call(null,vec__7430,0,null);var v = cljs.core.nth.call(null,vec__7430,1,null);return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.keyword.call(null,k.toLowerCase()),v], null);
});})(this$__$1))
,cljs.core.merge.call(null,cljs.core.js__GT_clj.call(null,goog.events.EventType))));
});
